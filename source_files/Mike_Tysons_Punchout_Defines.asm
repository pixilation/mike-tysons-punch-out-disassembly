...
SQ1_TALK1 =        $09     ;Talking SFX, version 1. Used for Little Mac.
SQ1_TALK2 =        $0A     ;Talking SFX, version 2. Used for Doc Louis.
SQ1_TALK3 =        $0B     ;Talking SFX, version 3. Used for opponents.
